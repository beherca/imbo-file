...
namespace Imbo\Resource\Files;

use Imbo\Exception\RuntimeException;

/**
 * Query object for the files resource
 *
...
class Query {
    ...
    /**
     * File identifiers filter
     *
     * @var array
     */
    private $fileIdentifiers = array();
    ...
    /**
     * Set or get the fileIdentifiers filter
     *
     * @param array $fileIdentifiers Give this a value to set the property
     * @return array|self
     */
    public function fileIdentifiers(array $fileIdentifiers = null) {
